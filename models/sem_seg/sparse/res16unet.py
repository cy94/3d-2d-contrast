from models.sem_seg.sparse.resnet import ResNetBase, get_norm
from models.sem_seg.sparse.modules.common import ConvType, NormType, conv, conv_tr
from models.sem_seg.sparse.modules.resnet_block import BasicBlock
...
class Res16UNetBase(ResNetBase):
  ...
  def __init__(self, in_channels, num_classes, cfg, D=3, **kwargs):
    super().__init__(in_channels, num_classes, cfg, D)
  ...
  def network_initialization(self, in_channels, num_classes, D):
    ...
    self.final = conv(self.PLANES[7], num_classes, kernel_size=1, stride=1, bias=True, D=D)
...
class SparseResUNet(Res16UNet34):
